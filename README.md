...
При компиляции с ключом -O0 большинство оптимизаций производительности при компиляции отключены, что может замедлить исполнение запроса, но не на порядок; поэтому мы все равно должны уложимся во временные диапазоны скорости исполнения запросов, указанные в задании. 
